...
if (MODULES)
	...
	foreach(it ${MODULES})
		...
		if ("${it}" STREQUAL "-core")
			set(KeywordIsKnown true)
			ynmessage("[!!] Module: Impossible to disable the core module")
		...
		if (NOT KeywordIsKnown)
			ynmessage("[!!] Unknown module from command line: `${it}` (ignored)")
			set(KeywordError true)
		endif()
	...
	if (KeywordError)
		ynmessage("")
		ynmessage("Errors on modules. Here is the list of all available modules :")
		ynmessage("(+ : Enable the module,  - disable the module)")
		ynmessage(" Main and virtual modules")
		ynmessage("    +core          : The core module (needed)")
		ynmessage("    -/+tests       : Atomic Tests for the yuni framework")
		ynmessage("    +all           : Enable all main modules (ui,tests,...)")
		ynmessage("    -/+docs        : Documentation Tools")
		#ynmessage(" The VFS module")
		#ynmessage("    -/+vfs         : The Virtual filesystem")
		#ynmessage("    -/+vfs-local   : Support for the local filesystems")
		ynmessage(" The device modules")
		ynmessage("    -/+devices     : All devices (display,keyboard,mouse...)")
		ynmessage("    -/+display     : The Display device")
		ynmessage("    -/+keyboard    : The Keyboard device")
		ynmessage("    -/+mouse       : The Mouse device")
		ynmessage(" The media modules")
		ynmessage("    -/+media       : The Media module (default: disabled)")
		ynmessage(" The graphics modules")
		ynmessage("    -/+opengl      : The OpenGL renderer module (default: disabled)")
		ynmessage(" The ui modules")
		ynmessage("    -/+ui          : The ui module (default: disabled)")
		ynmessage(" The virtual machine module")
		ynmessage("    -/+vm          : The Virtual machine")
		ynmessage(" The network modules")
		ynmessage("    -/+net         : The network core module (default: disabled)")
		ynmessage("    -/+messaging   : The messaging module (default: disabled)")
		ynmessage(" The DBI modules")
		ynmessage("    -/+dbi         : The Database Indepedent module (default: disabled)")
		ynmessage(" The extra modules")
		ynmessage("    -/+uuid        : UUID (default: disabled)")
		ynmessage("    -/+marshal     : The Marshal module (for Object serialization, default: disabled)")
		ynmessage("    -/+algorithms  : Standard algorithms")
		ynmessage("    -/+parser      : Parser Generator")
		ynmessage("    -/+benchmarks  : Benchmarks")
		ynmessage("")
