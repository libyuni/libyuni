...
macro(DEVPACK_IMPORT_OPENAL)
	...
	if(WIN32 OR WIN64)
		...
		ynerror("No OpenAL devpack for Unices !")
	endif()
...
macro(DEVPACK_IMPORT_FREETYPE)
	...
	if (WIN32 OR WIN64)
		if (WIN64)
			...
			ynerror("No freetype devpack for Windows 32-bit !")
		endif()
		set(FREETYPE_INCLUDE_DIR)
		set(FREETYPE_LIBRARY)
	else()
			...
			if (NOT config_error)
				...
				ynerror("[!!] Impossible to find Freetype !")
				ynmessage(" * Packages needed on Debian/Ubuntu: libfreetype6-dev")
				ynmessage(" * Packages needed on Fedora: freetype-devel")
			endif()
		#endif()
	endif()
